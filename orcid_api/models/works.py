...
class Works(object):
    ...
    def __init__(self, last_modified_date=None, group=None, path=None):
        """
        Works - a model defined in Swagger
    ...
    def path(self, path):
        """
        Sets the path of this Works.

        :param path: The path of this Works.
        :type: str
        """
