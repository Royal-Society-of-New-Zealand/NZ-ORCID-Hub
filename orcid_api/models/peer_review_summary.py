...
class PeerReviewSummary(object):
    ...
    """
    def __init__(self, created_date=None, last_modified_date=None, source=None, external_ids=None, completion_date=None, review_group_id=None, convening_organization=None, visibility=None, put_code=None, path=None, display_index=None):
        """
